...
void PlayerStatusDisplay::draw(SDL_Renderer* renderer)
{
	...
	_textureHits->loadFromRenderedText(Fonts::standard(), renderer, "Hits: " + to_string(_player->getHP()), Colors::TEXT_COLOR);
	_textureFood->loadFromRenderedText(Fonts::standard(), renderer, "Food: " + to_string(_player->getFood()), Colors::TEXT_COLOR);
	_textureXP->loadFromRenderedText(Fonts::standard(), renderer, "Exp.: " + to_string(_player->getXP()), Colors::TEXT_COLOR);
	_textureMoney->loadFromRenderedText(Fonts::standard(), renderer, "Coin: " + to_string(_player->getMoney()), Colors::TEXT_COLOR);
