...
TileAnimation::getRenderQuads(SDL_Renderer *renderer, AnimationType animationType, SDL_Rect spriteBox,
    ...
    switch (animationType) {
        ...
        case AnimationType::SCROLLING: {
            ...
            SDL_Rect lowerRenderQuad = {spriteBox.x, spriteBox.y + scrollOffset, spriteBox.w,
                                        spriteBox.h - scrollOffset};

            result.emplace_back(lowerPortionSource, upperRenderQuad);
            result.emplace_back(upperPortionSource, lowerRenderQuad);
        }
            break;
        case AnimationType::SWAP: {
            ...
            result.emplace_back(source, renderQuad);
        }
            break;
    }
